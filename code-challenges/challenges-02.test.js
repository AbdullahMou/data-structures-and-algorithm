...
Write a function named raisedToTheThird that takes in an array of numbers and returns a new array
 of each of those numbers raised to the 3rd power (hint: look up Math.pow()).
...
const raisedToTheThird = (arr) => {
    ...
    let finalArray = [];
    arr.forEach(element => {
        let numPowered = Math.pow(element, 3)
        finalArray.push(numPowered);
    });
    return finalArray;
}
